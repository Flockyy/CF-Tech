...
def test_admin_create():
    ...
    assert isinstance(admin_data, AdminCreate), (
    ...
    assert admin_data.email == "john.doe@example.com", (
...
def test_admin_instance():
    ...
    assert isinstance(admin_data, Admin), "admin_data should be an instance of Admin"
    assert admin_data.first_name == "Alice", "First name should be 'Alice'"
    assert admin_data.last_name == "Smith", "Last name should be 'Smith'"
    assert admin_data.email == "alice.smith@example.com", (
