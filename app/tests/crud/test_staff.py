...
def test_staff_create():
    ...
    assert isinstance(staff_data, StaffCreate), "staff_data should be an instance of StaffCreate"
    assert staff_data.first_name == "Alice", "First name should be 'Alice'"
    assert staff_data.last_name == "Smith", "Last name should be 'Smith'"
    assert staff_data.email == "alice.smith@example.com", "Email should be 'alice.smith@example.com'"
...
def test_staff_update():
    ...
    assert isinstance(staff_data, StaffUpdate), "staff_data should be an instance of StaffUpdate"
    assert staff_data.first_name == "Alice", "First name should be 'Alice'"
    assert staff_data.last_name == "Smith", "Last name should be 'Smith'"
    assert staff_data.email == "alice.smith@example.com", "Email should be 'alice.smith@example.com'"
    assert staff_data.position == "Manager", "Position should be 'Manager'"
...
def test_staff_instance():
    ...
    assert isinstance(staff_instance, Staff), "staff_instance should be an instance of Staff"
    ...
    assert staff_instance.email == "alice.smith@example.com", "Email should be 'alice.smith@example.com'"
