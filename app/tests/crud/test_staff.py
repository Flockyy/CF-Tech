...
def test_staff_create():
    ...
    assert isinstance(staff_data, StaffCreate), (
    ...
    assert staff_data.email == "alice.smith@example.com", (
...
def test_staff_update():
    ...
    assert isinstance(staff_data, StaffUpdate), (
...
def test_staff_instance():
    ...
    assert isinstance(staff_instance, Staff), (
    ...
    assert staff_instance.email == "alice.smith@example.com", (
        "Email should be 'alice.smith@example.com'"
    )
